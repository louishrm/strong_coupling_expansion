...
TEST_F(DimerCumulantPlanTest, Order1_FiniteU_Site0Up) { parity_sweep<2>(*solver, {2}, {2}, false, params.beta, 64, 0xD1u); }
TEST_F(DimerCumulantPlanTest, Order2_FiniteU_OnSite) { parity_sweep<2>(*solver, {2, 0}, {2, 0}, false, params.beta, 64, 0xD2u); }
TEST_F(DimerCumulantPlanTest, Order2_FiniteU_InterSite) { parity_sweep<2>(*solver, {2, 1}, {2, 1}, false, params.beta, 64, 0xD3u); }
TEST_F(DimerCumulantPlanTest, Order2_FiniteU_Mixed) { parity_sweep<2>(*solver, {2, 1}, {0, 3}, false, params.beta, 64, 0xD4u); }
TEST_F(DimerCumulantPlanTest, Order3_FiniteU) { parity_sweep<2>(*solver, {2, 0, 3}, {2, 0, 3}, false, params.beta, 48, 0xD5u); }
TEST_F(DimerCumulantPlanTest, Order4_FiniteU) { parity_sweep<2>(*solver, {2, 0, 3, 1}, {2, 0, 3, 1}, false, params.beta, 24, 0xD6u); }
TEST_F(DimerCumulantPlanTest, Order2_InfiniteU) { parity_sweep<2>(*solver, {2, 0}, {2, 0}, true, params.beta, 48, 0xD7u); }
TEST_F(DimerCumulantPlanTest, Order3_InfiniteU) { parity_sweep<2>(*solver, {2, 0, 3}, {2, 0, 3}, true, params.beta, 32, 0xD8u); }
TEST_F(DimerCumulantPlanTest, PlanIsTauIndependent_Order2) { plan_reuse_check<2>(*solver, {2, 0}, {2, 0}, false, params.beta, 48, 0xD90u); }
TEST_F(DimerCumulantPlanTest, PlanIsTauIndependent_Order3) { plan_reuse_check<2>(*solver, {2, 0, 3}, {2, 0, 3}, false, params.beta, 32, 0xD9u); }
