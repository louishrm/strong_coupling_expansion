...
TEST_F(HubbardAtomTest, CumulantOrderThreeMatchesExactResult) {
  ...
  HubbardAtom::cumul_args primed_args   = {{0.0, 0}, {0.3, 1}, {0.65, 1}};
  ...
  double C11_C22_C33 = -atom->G0({unprimed_args[0]}, {primed_args[0]})
     * atom->G0({unprimed_args[1]}, {primed_args[1]})
     * atom->G0({unprimed_args[2]}, {primed_args[2]}); //-G(1|1')*G(2|2')*G(3|3')

  double C11_C23_C32 = atom->G0({unprimed_args[0]}, {primed_args[0]})
     * atom->G0({unprimed_args[1]}, {primed_args[2]})
     * atom->G0({unprimed_args[2]}, {primed_args[1]}); //G(1|1')*G(2|3')*G(3|2')

  double C12_C21_C33 = atom->G0({unprimed_args[0]}, {primed_args[1]})
     * atom->G0({unprimed_args[1]}, {primed_args[0]})
     * atom->G0({unprimed_args[2]}, {primed_args[2]}); //G(1|2')*G(2|1')*G(3|3')

  double C12_C23_C31 = -atom->G0({unprimed_args[0]}, {primed_args[1]})
     * atom->G0({unprimed_args[1]}, {primed_args[2]})
     * atom->G0({unprimed_args[2]}, {primed_args[0]}); //  -G(1|2')*G(2|3')*G(3|1')

  double C13_C22_C31 = atom->G0({unprimed_args[0]}, {primed_args[2]})
     * atom->G0({unprimed_args[1]}, {primed_args[1]})
     * atom->G0({unprimed_args[2]}, {primed_args[0]}); //G(1|3')*G(2|2')*G(3|1')

  double C13_C21_C32 = -atom->G0({unprimed_args[0]}, {primed_args[2]})
     * atom->G0({unprimed_args[1]}, {primed_args[0]})
  ...
  double C03 = compute_cumulant_decomposition(unprimed_args, primed_args, *atom);
